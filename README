# CNP35_CHIKV-nsP2-helicase-spiro

CHIKV nsP2 helicase inhibitor development campaign by HTS

An SGC Open Chemistry Networks Project devoted to the discovery and development of CHIKV nsP2 helicase inhibitors. 
...
Professor Peter Brown, University of North Carolina Chapel Hill  [@tolune44](https://github.com/toluene44)    
Anwar Hossain, University of North Carolina Chapel Hill - [@ahsgc](https://github.com/ahsgc)  
Muthu Ramalingam, UNC Chapel Hill [@muthubose](https://github.com/Muthubose)
